 ...
 * @author kelompok4
 */
public class form_stok_keluar extends javax.swing.JFrame {

    private static final Logger logger = Logger.getLogger(form_stok_keluar.class.getName());
    private final ServiceFactory sf = ServiceFactory.getInstance();
    private int userId;
    private DefaultTableModel modelRiwayat;

    public form_stok_keluar(int userId) {
        this.userId = userId;
        initComponents();
        loadBarang();
        loadRiwayat();
    ...
    private void updateInfoStok() {
        Barang b = (Barang) jComboBoxBarang.getSelectedItem();
        if (b != null) {
            int stok = b.getStokSaatIni();
            jLabelStokInfo.setText(stok + " " + b.getSatuan());
            jLabelStokInfo.setForeground(stok <= b.getStokMinimum()
                ? java.awt.Color.RED
    ...
    private void loadRiwayat() {
        try {
            ...
            sf.getStokService().getAllStokKeluar().forEach(sk ->
                modelRiwayat.addRow(new Object[]{
                    sk.getNomorTransaksi(), sk.getBarangId(), sk.getDepartemenId(),
                    sk.getJumlah(), sk.getKeperluan(), sk.getTanggalKeluar()
                })
            );
        } catch (SQLException ex) {
            logger.log(Level.SEVERE, null, ex);
    ...
    private void simpan() {
        try {
            ...
            int departemenId = Integer.parseInt(jTextFieldDepartemenId.getText().trim());
            int jumlah = Integer.parseInt(jTextFieldJumlah.getText().trim());

            sf.getStokService().prosesStokKeluar(
                jTextFieldNoTransaksi.getText(), barang.getId(), departemenId,
                userId, jumlah, Date.valueOf(LocalDate.now()),
                jTextFieldKeperluan.getText(), jTextFieldCatatan.getText()
            );

            javax.swing.JOptionPane.showMessageDialog(this, "Stok keluar berhasil dicatat!");
            jTextFieldNoTransaksi.setText("SK-" + UUID.randomUUID().toString().substring(0, 8).toUpperCase());
            jTextFieldDepartemenId.setText("");
            jTextFieldJumlah.setText("");
            jTextFieldKeperluan.setText("");
            jTextFieldCatatan.setText("");
            loadBarang();
            loadRiwayat();
        } catch (NumberFormatException ex) {
            javax.swing.JOptionPane.showMessageDialog(this, "Departemen ID dan Jumlah harus berupa angka!", "Input Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        } catch (SQLException ex) {
            logger.log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jLabelStokTersedia = new javax.swing.JLabel();
        jLabelStokInfo = new javax.swing.JLabel();
        jLabelDepartemenId = new javax.swing.JLabel();
        jTextFieldDepartemenId = new javax.swing.JTextField();
        jLabelJumlah = new javax.swing.JLabel();
        jTextFieldJumlah = new javax.swing.JTextField();
        jLabelKeperluan = new javax.swing.JLabel();
        jTextFieldKeperluan = new javax.swing.JTextField();
        ...
        setTitle("Form Stok Keluar");
        setPreferredSize(new java.awt.Dimension(800, 620));

        jPanelForm.setBorder(javax.swing.BorderFactory.createTitledBorder("Input Stok Keluar"));

        jLabelNoTransaksi.setText("No. Transaksi:");

        jTextFieldNoTransaksi.setEditable(false);
        jTextFieldNoTransaksi.setText("SK-");

        jLabelBarang.setText("Barang:");

        jComboBoxBarang.addActionListener(this::jComboBoxBarangActionPerformed);

        jLabelStokTersedia.setText("Stok Tersedia:");

        jLabelStokInfo.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        jLabelStokInfo.setText("-");

        jLabelDepartemenId.setText("Departemen ID:");

        jLabelJumlah.setText("Jumlah:");

        jLabelKeperluan.setText("Keperluan:");
        ...
        jPanelFormLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelFormLayout.createSequentialGroup()
                ...
                .addGroup(jPanelFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabelStokTersedia)
                    .addComponent(jLabelDepartemenId)
                    .addComponent(jLabelJumlah)
                    .addComponent(jLabelKeperluan)
                ...
                .addGroup(jPanelFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabelStokInfo)
                    .addComponent(jTextFieldDepartemenId, 0, 300, Short.MAX_VALUE)
                    .addComponent(jTextFieldJumlah, 0, 300, Short.MAX_VALUE)
                    .addComponent(jTextFieldKeperluan, 0, 300, Short.MAX_VALUE)
        ...
        jPanelFormLayout.setVerticalGroup(
            ...
            .addGroup(jPanelFormLayout.createSequentialGroup()
                ...
                .addGroup(jPanelFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelDepartemenId)
                    .addComponent(jTextFieldDepartemenId, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanelFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelJumlah)
                ...
                .addGroup(jPanelFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelKeperluan)
                    .addComponent(jTextFieldKeperluan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanelFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelCatatan)
        ...
        jPanelRiwayat.setBorder(javax.swing.BorderFactory.createTitledBorder("Riwayat Stok Keluar"));
        ...
        jTableRiwayat.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No. Transaksi", "Barang ID", "Departemen ID", "Jumlah", "Keperluan", "Tanggal"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new form_stok_keluar().setVisible(true));
    }
    ...
    private javax.swing.JLabel jLabelDepartemenId;
    private javax.swing.JLabel jLabelJumlah;
    private javax.swing.JLabel jLabelKeperluan;
    private javax.swing.JLabel jLabelNoTransaksi;
    private javax.swing.JLabel jLabelRiwayat;
    private javax.swing.JLabel jLabelStokInfo;
    private javax.swing.JLabel jLabelStokTersedia;
    ...
    private javax.swing.JTextField jTextFieldDepartemenId;
    private javax.swing.JTextField jTextFieldJumlah;
    private javax.swing.JTextField jTextFieldKeperluan;
